<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Nuevo insumo</h2>
</div>
...
<div class="container pb-6 pt-6">
	...
	<form action="./php/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Fecha de instalación</label>
				  	<input class="input" type="date" name="producto_precio" pattern="[0-9.]{1,25}" maxlength="50" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Cantidad exitencias</label>
		...
		<div class="columns">
			<div class="column">
				<label>Foto o imagen de el insumo instalado</label><br>
