<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Actualizar insumo</h2>
</div>
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Fecha de instalación</label>
				  	<input class="input" type="date" name="producto_precio" pattern="[0-9.]{1,25}" maxlength="25" required value="<?php echo $datos['producto_precio']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
