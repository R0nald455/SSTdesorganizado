			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>Codigo:</strong> '.$rows['producto_codigo'].'  <strong>Fecha:</strong> '.$rows['producto_precio'].' <strong>Existencias:</strong> '.$rows['producto_stock'].' <strong>Área:</strong> '.$rows['categoria_nombre'].'
			              </p>
			            </div>
