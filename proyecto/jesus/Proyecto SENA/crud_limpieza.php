...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">CRUD Limpieza</a>
    ...
    <marquee class="anuncios_parroquiales">
        <h1>Hola esta es el CRUD de la tabla limpieza</h1>
    </marquee>

        <center>
            <form action="php/script_crud_limpieza.php" method="post">

            <h1>CRUD Limpieza</h1>

            <div class="form-group">
                <label for="id_Lim">ID_LIMPIEZA</label>
                <input type="text" name="id_Lim" class="form-control" id="id_Lim" placeholder="INGRESE EL ID DE LA LIMPIEZA">
            </div>

            <div class="form-group">
                <label for="Limpieza">NOMBRE_LIMPIEZA</label>
                <input type="text" name="Limpieza" class="form-control" id="Limpieza" placeholder="INGRESE LA DESCRIPCION DE LA LIMPIEZA">
            </div>

            <div class="form-group">
                <label for="Verificar_Lim">¿QUE SE VERIFICA EN LA LIMPIEZA?</label>
                <input type="text" name="Verificar_Lim" class="form-control" id="Verificar_Lim" placeholder="INGRESE EL VERIFICAR DE LA LIMPIEZA">
            </div>

            <div class="form-group">
                <label for="Calificacion_Lim">CALIFICACION</label>
                <input type="text" name="Calificacion_Lim" class="form-control" id="Calificacion_Lim" placeholder="INGRESE LA CALIFICACION DE LA ENTIDAD LIMPIEZA">
            </div>
...
<?php
    include("./php/script_crud_limpieza.php");
?>