...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">CRUD Disciplina</a>
    ...
    <marquee class="anuncios_parroquiales">
        <h1>Hola esta es el CRUD de la tabla Disciplina</h1>
    </marquee>

        <center>
            <form action="php/script_crud_disciplina.php" method="post">

            <h1>CRUD Disciplina</h1>

            <div class="form-group">
                <label for="id_Dis">ID_DISCIPLINA</label>
                <input type="text" name="id_Dis" class="form-control" id="id_Dis" placeholder="INGRESE EL ID DE LA DISCIPLINA">
            </div>

            <div class="form-group">
                <label for="Disciplina">NOMBRE_DISCIPLINA</label>
                <input type="text" name="Disciplina" class="form-control" id="Disciplina" placeholder="INGRESE LA DESCRIPCION DE LA DISCIPLINA">
            </div>

            <div class="form-group">
                <label for="Verificar_Dis">¿QUE SE VERIFICA EN LA DISCIPLINA?</label>
                <input type="text" name="Verificar_Dis" class="form-control" id="Verificar_Dis" placeholder="INGRESE EL VERIFICAR DE LA DISCIPLINA">
            </div>

            <div class="form-group">
                <label for="Calificacion_Dis">CALIFICACION</label>
                <input type="text" name="Calificacion_Dis" class="form-control" id="Calificacion_Dis" placeholder="INGRESE LA CALIFICACION DE LA ENTIDAD DISCIPLINA">
            </div>
...
<?php
    include("./php/script_crud_disciplina.php");
?>