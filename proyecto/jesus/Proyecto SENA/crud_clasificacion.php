...
<head>
    ...
    <title>CRUD Clasificacion</title>
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">CRUD Clasificacion</a>
    ...
    <marquee class="anuncios_parroquiales">
        <h1>Hola esta es el CRUD de la tabla clasificacion</h1>
    </marquee>

        <center>
            <form action="php/script_crud_clasificacion.php" method="post">

            <h1>CRUD Clasificacion</h1>

            <div class="form-group">
                <label for="id_Cla">ID_CLASIFICACION</label>
                <input type="text" name="id_Cla" class="form-control" id="id_Cla" placeholder="INGRESE EL ID DE LA CLASIFICACION">
            </div>

            <div class="form-group">
                <label for="Clasificacion">NOMBRE_CLASIFICACION</label>
                <input type="text" name="Clasificacion" class="form-control" id="Clasificacion" placeholder="INGRESE LA DESCRIPCION DE LA CLASIFICACION">
            </div>

            <div class="form-group">
                <label for="Verificar_Cla">¿QUE SE VERIFICA EN LA CLASIFICACION?</label>
                <input type="text" name="Verificar_Cla" class="form-control" id="Verificar_Cla" placeholder="INGRESE EL VERIFICAR DE LA CLASIFICACION">
            </div>

            <div class="form-group">
                <label for="Calificacion_Cla">CALIFICACION</label>
                <input type="text" name="Calificacion_Cla" class="form-control" id="Calificacion_Cla" placeholder="INGRESE LA CALIFICACION DE LA ENTIDAD CLASIFICACION">
            </div>
...
<?php
    include("./php/script_crud_clasificacion.php");
?>